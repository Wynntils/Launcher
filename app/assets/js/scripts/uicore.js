        ...
        switch(arg){
            ...
            case 'update-available':
                ...
                if(process.platform === 'darwin'){
                    info.darwindownload = `https://github.com/Wynntils/Launcher/releases/download/v${info.version}/wynntilslauncher-setup-${info.version}.dmg`
                    showUpdateUI(info)
                }
...
function showUpdateUI(info){
    ...
    document.getElementById('image_wynntils_container').setAttribute('update', true)
    document.getElementById('image_wynntils_container').onclick = () => {
